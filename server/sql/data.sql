...
insert into taxi_data (reg_number, qty, owner_id) values ('CL 789 123', 15, 6);
insert into taxi_data (reg_number, qty, owner_id) values ('CJ 345 456', 15, 7);
insert into taxi_data (reg_number, qty, owner_id) values ('CAA 000 123', 15, 8);
insert into taxi_data (reg_number, qty, owner_id) values ('CA 345 123', 15, 9);
insert into taxi_data (reg_number, qty, owner_id) values ('CK 453 123', 15, 10);
insert into taxi_data (reg_number, qty, owner_id) values ('CAA 789 876', 15, 11);
insert into taxi_data (reg_number, qty, owner_id) values ('CA 678 889', 15, 12);
insert into taxi_data (reg_number, qty, owner_id) values ('CJ 123 000', 15, 13);
insert into taxi_data (reg_number, qty, owner_id) values ('CK 678 123', 15, 14);
insert into taxi_data (reg_number, qty, owner_id) values ('CJ 111 223', 15, 15);

insert into users (name, surname, username, password, role) values ('Thabo', 'Yona', 'Thabo', 'Thabo', 'Driver');
insert into users (name, surname, username, password, role) values ('Bonnie', 'Yona', 'Bonnie', 'Bonnie', 'Driver');
insert into users (name, surname, username, password, role) values ('Tshifi', 'Yona', 'Tshifi', 'Tshifi', 'Driver');
insert into users (name, surname, username, password, role) values ('Sino', 'Yona', 'Sino', 'Sino','Driver');
insert into users (name, surname, username, password, role) values ('Sinovuyo', 'Yona','Sinovuyo' ,'Sinovuyo', 'Driver');
...
insert into users (name, surname, username, password, role) values ('Clara', 'Yona', 'Clara', 'Clara','Driver');
insert into users (name, surname, username, password, role) values ('Xabiso', 'Yona', 'Xabiso', 'Xabiso','Driver');
insert into users (name, surname, username, password, role) values ('Khosie', 'Yona', 'Khosie',  'Khosie','Driver');
insert into users (name, surname, username, password, role) values ('Phumza', 'Yona', 'Phumza', 'Phumza', 'Driver');
insert into users (name, surname, username, password, role) values ('Mpumi', 'Yona', 'Mpumi', 'Mpumi', 'Driver');
